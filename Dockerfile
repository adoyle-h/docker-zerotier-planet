...
RUN sed -i 's/dl-cdn.alpinelinux.org/mirrors.tuna.tsinghua.edu.cn/g' /etc/apk/repositories \
    && apk update\
    && mkdir -p /usr/include/nlohmann/ && cd /usr/include/nlohmann/ && wget https://gh-proxy.com/https://github.com/nlohmann/json/releases/download/v3.10.5/json.hpp \
    && apk add --no-cache git python3 npm make g++ zerotier-one linux-headers\
    && mkdir /app -p &&  cd /app && git clone --progress https://gh-proxy.com/https://github.com/key-networks/ztncui.git\
    && cd /app/ztncui/src \
...
RUN cd /app && git clone --progress https://gh-proxy.com/https://github.com/zerotier/ZeroTierOne.git --depth 1\
